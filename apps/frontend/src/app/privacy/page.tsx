                    ...
                    <GlassCard className="p-8 md:p-12 space-y-12">
                        <section>
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xl font-black text-text-primary uppercase italic tracking-wider">{t('sections.encryption.title')}</h2>
                            </div>
                            <p className="text-text-secondary leading-relaxed font-medium">
                                {t('sections.encryption.content')}
                            </p>
                        </section>

                        <section className="grid md:grid-cols-2 gap-8">
                            <div>
                                <h3 className="text-sm font-black text-primary uppercase tracking-[0.2em] mb-4">{t('sections.metrics.title')}</h3>
                                <ul className="space-y-3">
                                    {(t.raw('sections.metrics.items') as string[]).map((item) => (
                            ...
                            <div>
                                <h3 className="text-sm font-black text-primary uppercase tracking-[0.2em] mb-4">{t('sections.utilization.title')}</h3>
                                <ul className="space-y-3">
                                    {(t.raw('sections.utilization.items') as string[]).map((item) => (
                                        <li key={item} className="flex items-center gap-2 text-text-tertiary text-sm font-mono">
                        ...
                        <section className="border-t border-white/[0.05] pt-12">
                            <h2 className="text-xl font-black text-text-primary uppercase italic tracking-wider mb-6">{t('sections.compliance.title')}</h2>
                            <p className="text-text-secondary leading-relaxed mb-6 font-medium">
                                {t('sections.compliance.content')}
                            </p>
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                {(t.raw('sections.compliance.rights') as string[]).map((right) => (
