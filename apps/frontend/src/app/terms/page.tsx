                    ...
                    <GlassCard className="p-8 md:p-12 space-y-12">
                        <section>
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xl font-black text-text-primary uppercase italic tracking-wider">{t('sections.agreement.title')}</h2>
                            </div>
                        ...
                        <section className="grid md:grid-cols-2 gap-8">
                            <div className="bg-surface-hover/30 p-6 rounded-2xl border border-white/[0.03]">
                                <h3 className="text-xs font-black text-primary uppercase tracking-[0.2em] mb-4">{t('sections.obligations.title')}</h3>
                                <ul className="space-y-3">
                                    {(t.raw('sections.obligations.items') as string[]).map((item) => (
                            ...
                            <div className="bg-surface-hover/30 p-6 rounded-2xl border border-white/[0.03]">
                                <h3 className="text-xs font-black text-primary uppercase tracking-[0.2em] mb-4">{t('sections.restricted.title')}</h3>
                                <ul className="space-y-3">
                                    {(t.raw('sections.restricted.items') as string[]).map((item) => (
                                        <li key={item} className="flex items-center gap-3 text-text-secondary text-xs font-mono">
                        ...
                        <section className="border-t border-white/[0.05] pt-12">
                            <h2 className="text-xl font-black text-text-primary uppercase italic tracking-wider mb-6">{t('sections.reliability.title')}</h2>
                            <p className="text-text-secondary leading-relaxed font-medium">
                                {t('sections.reliability.content')}
                            </p>
                        </section>

                        <section className="border-t border-white/[0.05] pt-12">
                            <h2 className="text-xl font-black text-text-primary uppercase italic tracking-wider mb-6">{t('sections.jurisdiction.title')}</h2>
                            ...
                            <div className="flex items-start gap-4 p-4 bg-primary/5 rounded-xl border border-primary/10">
                                ...
                                <p className="text-[10px] text-text-tertiary uppercase tracking-widest leading-relaxed">
                                    {t('sections.jurisdiction.entity')}
                                </p>
                            </div>
                        </section>

                        <section className="border-t border-white/[0.05] pt-12">
                            <h2 className="text-xl font-black text-text-primary uppercase italic tracking-wider mb-6">{t('sections.contact.title')}</h2>
                            <p className="text-text-secondary leading-relaxed font-medium">
